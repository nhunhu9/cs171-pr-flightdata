    ...
    if ( options.scope === 'usa' ) {
      projection = d3.geo.albersUsa()
       ...
       projection = d3.geo[options.projection]()
        ...
        projection = d3.geo[options.projection]()
        .center([66.166667, 34.4444])
        .scale(2430*0.43166977928720796)
        .translate([width / 2-1055.4566615143528-250, height / 2 + 169.26318673172355-130]);
   } else if ( options.scope === 'vnm' ) {
  projection = d3.geo[options.projection]()
  .center([66.166667, 34.4444])
  .scale(2430*0.43166977928720796*1.546116449337655*1.0526311547094405)
  .translate([width / 2-1055.4566615143528-250+711.0205122857296-610.96490112645, height / 2 + 169.26318673172355-130-784.5184106920008+164.63995089414033]);
